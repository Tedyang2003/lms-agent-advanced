...
// --- Structured data (utils/structuredData/loadStructuredData.ts, tools/structuredData/structuredDataSubAgentTools.ts, buildStructuredDataQueryTool.ts, utils/structuredData/structuredDataPreview.ts) ---
