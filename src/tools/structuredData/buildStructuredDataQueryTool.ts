...
import { z } from "zod";
import { getOrCreateDb, queryAll } from "../../utils/structuredData/loadStructuredData";
...
// query_structured_data call is pure waste. Keyed the same way as the DB cache in loadStructuredData.ts.
